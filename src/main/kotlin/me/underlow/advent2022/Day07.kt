...
fun main() {
    ...
    val fs = NoSpaceLeftOnDevice.processCommands(tokens)
    fs.calculateSizes()
...
//    fs.parent = fs
                ...
                is Cd -> {
                    when (token.direction) {
                        ...
                        ".." -> {
                            ...
                            val newDir =
                                currentDir.children.filterIsInstance<Directory>().find { it.name == token.direction }
                            currentDir = newDir!!
                        }
                    }
                }
    ...
    data class Directory(
        ...
        val children: MutableList<FilesystemItem>
    ) :
        FilesystemItem {
