package me.underlow.advent2022.day15
...
fun main() {
    val lines = getResourceAsLines("/15 - BeaconExclusionZoneInput.txt")

    val s1 = solution1(lines, 2000000)
    val s2 = solution2(lines, 0..4000000, 0..4000000)
