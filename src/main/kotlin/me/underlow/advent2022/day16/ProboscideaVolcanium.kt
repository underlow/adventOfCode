package me.underlow.advent2022.day16
...
fun main() {
    val list = getResourceAsLines("/16 - ProboscideaVolcaniumInput.txt")
    val result = solution1(list)
    println(result)

    // 1048 is solution1 for 26 ticks, idea here is that we take not intercepting ways, won't work for another input
    val result2 = solution2(list) + 1048
    println(result2)
