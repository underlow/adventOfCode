...
object RaceCondition {
    ...
    fun part12(list: List<String>, save: Int): Int {
        val field = list.parseToMap()
        ...
        for ((idx, p1) in (listOf(start) + baseline).withIndex()) {
            ...
            val allPointsDistance = field.getAllPointsDistance(p1, 2)
    ...
    fun part2(list: List<String>, save: Int): Int {
        val field = list.parseToMap()
        ...
        for ((idx, p1) in (listOf(start) + baseline).withIndex()) {
            ...
            // all points we can get to in 20 steps
            val allPointsDistance = field.getAllPointsDistance(p1, 21)
...
fun main() {
    ...
    val res1 = RaceCondition.part12(input, 100)
    val res2 = RaceCondition.part2(input, 100)
